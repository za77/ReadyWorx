...
@section('content')
        ...
        <div id="page_content_inner">
            ...
            <h3 class="heading_b uk-margin-bottom">Manage Product</h3>
                        ...
                        <div class="md-card-head">
                            <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-left'}">
                                ...
                                <div class="uk-dropdown uk-dropdown-small">
                                    <ul class="uk-nav">
                                        <li><a href="{{ url('admin/products/$data->id/edit') }}">Edit</a></li>
                                        <li><a onclick="remove("products",{{$data->id}})">Remove</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="uk-text-center">
                                <img class="md-card-head-avatar" src="{{ url($data->pic) }}" alt=""/>
                            </div>
                            <h3 class="md-card-head-text uk-text-center">
                                {{ $data->name?$data->name:'empty' }}                               <span class="uk-text-truncate">{{ $data->categoryName?$data->categoryName:'empty' }} </span>
                            </h3>
                        </div>
                        <div class="md-card-content">
                            <ul class="md-list">
                                <li>
                                    <div class="md-list-content">
                                        ...
                                        <span class="uk-text-small uk-text-muted" style="height:30px;">{{ str_limit($data->desc,150) }}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="md-list-content">
                                        <span class="md-list-heading">Product Code</span>
                                        <span class="uk-text-small uk-text-muted uk-text-truncate">{{ $data->productCode?$data->productCode:'empty' }}
                                    </div>
                                </li>
                                <li>
                                    <div class="md-list-content">
                                        <span class="md-list-heading">Price</span>
                                        <span class="uk-text-small uk-text-muted">{{ $data->price?$data->price:'empty' }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
