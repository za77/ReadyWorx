                            ...
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-1">
                                        ...
                                        <input type="text" class="md-input" value="{{$res->name}}" name="name" />
                                    </div>
                                    <div class="uk-width-medium-1-1 uk-margin-large-top">
                                        <label>Description</label>
                                        <textarea rows="4"  class="form-control" name="desc" />{{$res->desc}}</textarea>
                                    </div>
                                     <div class="uk-width-medium-1-3 uk-margin-large-top">
                                         <div class="input-group">
                                            <input id="uploadFile" class="form-control" value="{{$res->pic}}" placeholder="Choose File" disabled="disabled">
                                          ...
                                          <input type="hidden" name="id" name="{{ $res->id }}">
                                    </div>
                                    <div class="uk-width-medium-1-1">
